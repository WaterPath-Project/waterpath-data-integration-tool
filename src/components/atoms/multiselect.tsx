      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1  rounded-[8px] border border-wpBrown-100 min-h-12 h-auto items-center justify-between bg-wpWhite hover:bg-wpWhite [&_svg]:pointer-events-auto",
              className
            )}
          >
